  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(
          child: 
//            Image(image: AssetImage('assets/images/codepoint-logo.png'))
          Icon(
            Icons.terrain,
            color: mainColor,
            size: 40,
            ...
            children: [
              ...
              Row(
                children: [
                  ClipOval(
                    child: Image.network(
                      'https://avatars.githubusercontent.com/u/701248?s=400&u=19bd63244874f949614f3b8bf08099cd31ca1cce&v=4', // replace if you want
                      width: 50,
                      height: 50,
                      fit: BoxFit.cover
                    ),
        ...
        itemBuilder: (context, index) {
          ...
          return Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(currentMount.name, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                Text(currentMount.location, style: TextStyle(color: Colors.white)),
              ],
            ),
          );
        }
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('See more', style: TextStyle(color: mainColor, fontSize: 12, fontWeight: FontWeight.bold)),
              ]
            ),
          ),
          Container(
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(currentCategory.category, style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                    ],
                  ),
                );
              }
...
final List<MountModel> mountItems = [
  ...
  MountModel(
      path: 'https://cdn.britannica.com/s:800x450,c:crop/80/195880-138-31821A6D/kinds-eruptions.jpg',
      name: 'Mauna Loa',
      description:
